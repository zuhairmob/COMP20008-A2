...
features = ['runtime', 'imdb_votes', 'tmdb_popularity', 'age_certification']
...
plt.title('Scree Plot - Explained Variance Ratio (Movies)')
...
plt.title('Cumulative Explained Variance Plot (Movies)')
plt.grid(True)

plt.tight_layout()
plt.savefig('pca_variance_plots_movies.png')
plt.close()
...
plt.title('Feature Loadings in Principal Components (Movies)')
plt.colorbar(label='Feature Value')
plt.legend()
plt.grid(True)
plt.savefig('pca_feature_loadings_movies.png')
plt.close()

# Output explained variance ratios for each principal component
print("Explained Variance Ratios for Principal Components (Movies):")
