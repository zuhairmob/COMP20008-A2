...
features = ['runtime', 'age_certification', 'imdb_votes', 'tmdb_popularity', 'seasons']
...
plt.title('IMDb Regression Model for Shows')
...
plt.savefig('imdb_regression_model_shows.png')
...
plt.title('TMDB Regression Model for Shows')
...
plt.savefig('tmdb_regression_model_shows.png')
...
plt.title('Feature Importance Plot (IMDB) for Shows')
plt.xticks(rotation=45)

# Save the IMDb feature importance plot
plt.savefig('imdb_feature_importance_shows.png')
...
plt.xlabel('Features')
plt.ylabel('Absolute Coefficient Magnitude')
plt.title('Feature Importance Plot for Shows(TMDB)')
plt.xticks(rotation=45)

# Save the TMDB feature importance plot
plt.savefig('tmdb_feature_importance_shows.png')

plt.tight_layout()

# Print model performance metrics for IMDb
print("IMDB Model Metrics for Shows:")
